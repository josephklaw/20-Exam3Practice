    ...
    for k in range(len(sequence_of_sequences)):
        for j in range(len(sequence_of_sequences[k])):
            if type(sequence_of_sequences[k]) is str:
                for l in range(len(sequence_of_sequences[k][j])):
                    if sequence_of_sequences[k][j][l].isupper():
                        seq.append(sequence_of_sequences[k][j][l])
    stringy = ""
    for k in range(len(seq)):
        stringy = stringy + seq[k]
    return stringy
# -----------------------------------------------------------------------------
